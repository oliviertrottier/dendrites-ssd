...
from data import VOC_ROOT, ObjectTransform, TreeDataset, TreeRealDataset, BaseTransform
...
elif args.dataset in ['Tree28_synthesis3', 'Tree29_synthesis3', 'Tree_Real']:
...
if __name__ == '__main__':
    ...
    # Load dataset.
    dataset = TreeRealDataset(root=args.dataset_root, name=args.dataset,
